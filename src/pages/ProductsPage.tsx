...
export const ProductsPage = () => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-green-50 to-orange-50 text-gray-800">
      {/* Decorative background elements */}
      <div className="absolute w-96 h-96 bg-orange-200/30 rounded-full blur-3xl -top-20 -right-20 z-0" />
      <div className="absolute w-96 h-96 bg-green-200/20 rounded-full blur-2xl -bottom-32 -left-32 z-0" />
      ...
      >
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-12">Our Product Categories</h2>
      ...
      <motion.div variants={fadeInUp} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="gradient-section p-8">
          <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-12">Our Certifications</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 text-center mb-2">{cert.name}</h3>
      ...
      <motion.div variants={fadeInUp} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pb-16">
        <div className="gradient-section p-8">
          <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-12">Why Choose Our Products?</h2>
